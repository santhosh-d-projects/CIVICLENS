...
ai-prototype/
├── documents/
│   └── demo/                     # Demo government document PDFs
├── src/
│   ├── __init__.py
...
curl -X POST http://127.0.0.1:8000/ai/ask \
  ...
  -d '{"question": "What is the budget of Ward 12 Road Development?", "projectId": "P001"}'
```
...
|---|----------|--------------------------------|-----------------|
| 1 | What is the budget of the Ward 12 Road Development project? | Total sanctioned budget is Rs 45.0 Crore (Forty Five Crore). | Ward 12 Project Report, Page 2 / Budget Report, Page 1 |
| 2 | When was the project expected to be completed? | Original completion date was June 30, 2026. | Ward 12 Project Report, Page 4 |
| 3 | What was the latest reported progress? | Notes conflict neutrally: Govt official record states 70%, while contractor report claims 75%. | Ward 12 Project Report, Page 5 & Progress Report, Page 1 |
| 4 | Why was the project delayed? | Heavy monsoon rainfall (Aug-Sep 2025) and state electricity cable relocation delays. | Ward 12 Progress Report, Page 3 |
| 5 | Who is the contractor? | Skyline Infrastructure Pvt Ltd (MD: Vikram Shah). | Ward 12 Project Report, Page 3 / Tender Report, Page 2 |
